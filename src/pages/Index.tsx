        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'About', 'Portfolio', 'Skills', 'Experience', 'Contact'].map((item) => (
                <button
                  key={item}
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex space-x-4">
              ...
              <Button 
                ...
                variant="outline"
                className="border-gray-600 text-gray-300 hover:bg-gray-800 px-8 py-3 rounded-lg font-medium"
              >
                Contact Me
              </Button>
            </div>
            ...
            <div className="flex space-x-6 pt-4">
              <a href="https://linkedin.com/in/siva-sai-kumar" target="_blank" rel="noopener noreferrer" 
                 className="text-gray-400 hover:text-blue-400 transition-colors">
                <Linkedin className="h-6 w-6" />
              </a>
              <a href="mailto:sivasai78342@gmail.com" 
                 className="text-gray-400 hover:text-blue-400 transition-colors">
                <Mail className="h-6 w-6" />
              </a>
              <a href="https://github.com/sivasaikumar" target="_blank" rel="noopener noreferrer"
                 className="text-gray-400 hover:text-blue-400 transition-colors">
            ...
            <div className="space-y-6">
              <Card className="bg-gray-900 border-gray-700 p-6">
                ...
                <p className="text-gray-300 leading-relaxed mt-4">
                  Beyond coding, I express my creativity through painting, music, and writing, which helps me approach 
                  technical challenges with innovative perspectives.
                </p>
              </Card>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-gray-900 border-gray-700 p-6">
              ...
              <div className="space-y-3">
                {['Java', 'Python', 'HTML', 'CSS'].map((skill) => (
